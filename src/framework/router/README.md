    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'Monitor',
            hidden: true,
            component: () => import('@/framework/views/dashboard/Monitor'),
        ...
        children: [
          {
            path: '/result/success',
            name: 'ResultSuccess',
            component: () => import(/* webpackChunkName: "result" */ '@/framework/views/result/Success'),
            // 该页面隐藏面包屑和页面标题栏
          ...
          },
          {
            path: '/result/fail',
            name: 'ResultFail',
            component: () => import(/* webpackChunkName: "result" */ '@/framework/views/result/Error'),
            // 该页面隐藏面包屑和页面标题栏
