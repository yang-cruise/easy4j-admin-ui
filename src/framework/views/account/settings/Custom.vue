...
<script>
import { colorList } from '@/framework/components/SettingDrawer/settingConfig'
import { baseMixin } from '@/framework/store/app-mixin'
import { NAV_THEME, TOGGLE_NAV_THEME } from '@/framework/store/mutation-types'
